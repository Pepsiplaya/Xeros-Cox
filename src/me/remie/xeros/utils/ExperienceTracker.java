...
public class ExperienceTracker {
    ...
    private class Tracker {
        ...
        private long getTimeToMax() {
            return (long) (((ctx.skills.getExperienceAt(ctx.skills.getRealLevel(99)) - ctx.skills.getExperience(skill.getSkillIndex())) * 3600000D) / (double) getGainedXPPerHour());
        }
