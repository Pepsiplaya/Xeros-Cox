...
public class GUI {
	...
	public AIOWoodcutter chop;
	private JPanel contentPane;
	public JFrame frame;
	
	public JPanel generalPanel;
	public JComboBox<Trees> comboBoxOres;
	...
	public void initComponents() {
		...
		lbltreeType.setBounds(10, 11, 81, 20);
		generalPanel.add(lbltreeType);
		
		comboBoxOres = new JComboBox<Trees>(new DefaultComboBoxModel<Trees>(Trees.values()));
		comboBoxOres.setBounds(93, 11, 91, 20);
		generalPanel.add(comboBoxOres);
	}
	
	public void onApplyNewSettings() {
		Trees treeType = (Trees) comboBoxOres.getSelectedItem();
		if (treeType == Trees.NONE) {
			chop.setupTrees(null);
		} else {
			chop.setupTrees(treeType.getObjectId());
		}
		chop.started = true;
	}
